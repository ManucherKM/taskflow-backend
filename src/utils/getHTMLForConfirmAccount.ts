							...
							<tbody>
								<tr>
									<td style="padding:40px 0 0">
										...
										<div style="padding:20px;border-radius:12px;border:1px solid #27272a;">
											<div style="color:#a1a1aa;text-align:left">
												<h1 style="margin:1rem 0;color:#fafafa">Final step...</h1>
												...
												<p style="padding-bottom:16px"><a href="${activationLink}" target="_blank"
														style="padding:12px 24px;border-radius:4px;color:#000;background:#fafafa;display:inline-block;margin:.5rem 0;text-decoration:none">Confirm
														now</a></p>
